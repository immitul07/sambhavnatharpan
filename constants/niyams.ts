...
const NIYAM_DEFINITIONS: Record<string, NiyamDefinition> = {
  ...
  navkarvali: { key: "navkarvali", en: "Baandhi Navkarvali", gu: "\u0AAC\u0ABE\u0A82\u0AA7\u0AC0 \u0AA8\u0AB5\u0A95\u0ABE\u0AB0\u0AB5\u0ABE\u0AB3\u0AC0" },
...
const NIYAMS_BY_AGE_GROUP: Record<NiyamAgeGroup, AgeGroupRow[]> = {
  born_2011_or_later: [
    { key: "jin_pooja", points: 50 },
    { key: "say_namo_jinanam_on_dhwaja_darshan", points: 50 },
    { key: "say_nissihi_while_entering_derasar", points: 50 },
    { key: "offer_3_pradakshinas", points: 50 },
    { key: "chaityavandan", points: 50 },
    { key: "guruvandan", points: 50 },
    { key: "evening_darshan", points: 50 },
    { key: "navkar_27", points: 50 },
    { key: "om_hrim_arham_27_times", points: 50 },
    { key: "attend_pathshala", points: 50 },
    { key: "seven_navkar_sleep_eight_wake", points: 50 },
    { key: "navkarshi", points: 50 },
    { key: "give_up_night_meal", points: 50 },
    { key: "give_up_root_vegetables", points: 50 },
    { key: "drink_water_after_washing_plate_one_meal", points: 50 },
    { key: "no_talking_while_eating_before_water", points: 50 },
    { key: "eat_1_roti_without_ghee", points: 50 },
    { key: "give_up_prohibited_food", points: 50 },
    { key: "no_tv_mobile_during_meals", points: 50 },
    { key: "feeding_any_animal", points: 50 },
    { key: "perform_anukampa_daan", points: 50 },
    { key: "do_not_lie", points: 50 },
    { key: "seek_forgiveness_for_anger_at_family", points: 50 },
    { key: "do_not_use_abusive_words", points: 50 },
    { key: "praise_family_member_for_good_deed", points: 50 },
    { key: "bow_to_parents_or_photo", points: 50 },
    { key: "give_up_movies_web_series_tv_mobile", points: 50 },
    { key: "give_up_bathing_soap", points: 50 },
    { key: "sit_with_family_15_min", points: 50 },
    { key: "no_tv_phone_11pm_to_6am", points: 50 },
  ],
  born_1981_to_2010: [
    { key: "jin_pooja", points: 50 },
    { key: "offer_3_pradakshinas", points: 50 },
    { key: "chaityavandan", points: 50 },
    { key: "guruvandan", points: 50 },
    { key: "samayik", points: 50 },
    { key: "jinvani_shravan_30_min", points: 50 },
    { key: "navkarvali", points: 50 },
    { key: "om_hrim_arham_jaapmala", points: 50 },
    { key: "attend_pathshala", points: 50 },
    { key: "seven_navkar_sleep_eight_wake", points: 50 },
    { key: "navkarshi", points: 50 },
    { key: "give_up_night_meal", points: 50 },
    ...
    { key: "no_talking_while_eating_before_water", points: 50 },
    { key: "give_up_prohibited_food", points: 50 },
    { key: "give_up_tobacco_smoking_vape", points: 50 },
    { key: "no_tv_mobile_during_meals", points: 50 },
    { key: "seek_forgiveness_for_anger_at_family", points: 50 },
    { key: "do_not_use_abusive_words", points: 50 },
    { key: "do_not_speak_ill_of_others", points: 50 },
    { key: "praise_family_member_for_good_deed", points: 50 },
    { key: "bow_to_parents_or_photo", points: 50 },
    { key: "give_up_movies_web_series_tv_mobile", points: 50 },
    { key: "give_up_bathing_soap", points: 50 },
    { key: "give_up_perfume", points: 50 },
    { key: "silence_1_hour", points: 50 },
    { key: "sit_with_family_15_min", points: 50 },
    { key: "restrict_social_media_1_hour", points: 50 },
    { key: "no_tv_phone_11pm_to_6am", points: 50 },
  ],
  born_1980_or_earlier: [
    { key: "jin_pooja", points: 50 },
    { key: "ashtaprakari_pooja", points: 50 },
    { key: "offer_3_pradakshinas", points: 50 },
    { key: "chaityavandan", points: 50 },
    { key: "guruvandan", points: 50 },
    { key: "rai_or_devasiya_pratikraman", points: 50 },
    { key: "samayik", points: 50 },
    { key: "jinvani_shravan_30_min", points: 50 },
    { key: "navkarvali", points: 50 },
    { key: "om_hrim_arham_jaapmala", points: 50 },
    ...
    { key: "drink_water_after_washing_plate_one_meal", points: 50 },
    { key: "no_talking_while_eating_before_water", points: 50 },
    { key: "drink_boiled_water", points: 50 },
    { key: "give_up_prohibited_food", points: 50 },
    { key: "give_up_tobacco_smoking_vape", points: 50 },
    { key: "seek_forgiveness_for_anger_at_family", points: 50 },
    { key: "do_not_use_abusive_words", points: 50 },
